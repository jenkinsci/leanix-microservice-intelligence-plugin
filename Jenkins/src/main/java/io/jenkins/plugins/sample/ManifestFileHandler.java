...
public class ManifestFileHandler {
    ...
    public int sendFileToConnector(String hostname, String jwtToken, String deploymentVersion, String deploymentStage, String dependencyManage) throws IOException {
