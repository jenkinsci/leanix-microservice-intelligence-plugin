...
*  "settings": In this array settings for pipelines can be bundled.
...
Before adding the LeanIX build step to the pipeline, add a secured credentials environment with the Credentials Binding Plugin, as indicated under [Prerequisites] (# PrePrerequisites). The corresponding line Environment looks like this:
...
To configure the LeanIX plugin step you can use the "pipeline Syntax"generator of Jenkins. 
